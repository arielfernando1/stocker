<div class="overflow-x-auto">
    <input wire:model.live="search" type="text" placeholder="Buscar items ..." class="mb-4 px-4 py-2 border border-gray-300 rounded-md">
        ...
        <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-700 dark:text-gray-200">
            ...
            <tr>
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                    <a href="{{ route('items.show', $item->id) }}" class="btn btn-primary"><i class="bi bi-eye"></i> Ver</a>
                </td>
            </tr>
            @endforeach
        </tbody>
